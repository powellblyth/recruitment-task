 ...
 */
class CSVImporterChunked extends FileReader {
    ...
    public function __construct(string $filePath) {
        throw new Exception("CSVImporterChunked is not complete and cannot be used. Please use CSVImporter for $filePath");
    }
    ...
    protected function fetchChunk(int $start, $lines = null)
    {
        ...
        {
            throw new Exception("No file handle, initiate handle before fetching data");
        }
